...
############   renter ### above median income      ###############
 ...
 richRenterAshdod2004        <- RenterAshdod2004        %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterHaifa2004         <- RenterHaifa2004         %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterHerzliyya2004     <- RenterHerzliyya2004     %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterHolon2004         <- RenterHolon2004         %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterLod2004           <- RenterLod2004           %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterHadera2004        <- RenterHadera2004        %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterAshqelon2004      <- RenterAshqelon2004      %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterNettanya2004      <- RenterNettanya2004      %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterRehovot2004       <- RenterRehovot2004       %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterRamla2004         <- RenterRamla2004         %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterRaannana2004      <- RenterRaannana2004      %>%  dplyr::filter( grossIncome > medianInc2004)
 richRentertlv2004           <- Rentertlv2004           %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterbene2004          <- Renterbene2004          %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterbat2004           <- Renterbat2004           %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterkefar2004         <- Renterkefar2004         %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterpetah2004         <- Renterpetah2004         %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterrishon2004        <- Renterrishon2004        %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterramat2004         <- Renterramat2004         %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterbeer2004          <- Renterbeer2004          %>%  dplyr::filter( grossIncome > medianInc2004)
 richRentermodiin2004        <- Rentermodiin2004        %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterbetshemesh2004    <- Renterbetshemesh2004    %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenternahariyya2004     <- Renternahariyya2004     %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterqiryatatta2004    <- Renterqiryatatta2004    %>%  dplyr::filter( grossIncome > medianInc2004)
 richRentergivatayim2004     <- Rentergivatayim2004     %>%  dplyr::filter( grossIncome > medianInc2004)

 richRenterjerusalem2005     <- Renterjerusalem2005     %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterAshdod2005        <- RenterAshdod2005        %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterHaifa2005         <- RenterHaifa2005         %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterHerzliyya2005     <- RenterHerzliyya2005     %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterHolon2005         <- RenterHolon2005         %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterLod2005           <- RenterLod2005           %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterHadera2005        <- RenterHadera2005        %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterAshqelon2005      <- RenterAshqelon2005      %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterNettanya2005      <- RenterNettanya2005      %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterRehovot2005       <- RenterRehovot2005       %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterRamla2005         <- RenterRamla2005         %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterRaannana2005      <- RenterRaannana2005      %>%  dplyr::filter( grossIncome > medianInc2005)
 richRentertlv2005           <- Rentertlv2005           %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterbene2005          <- Renterbene2005          %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterbat2005           <- Renterbat2005           %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterkefar2005         <- Renterkefar2005         %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterpetah2005         <- Renterpetah2005         %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterrishon2005        <- Renterrishon2005        %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterramat2005         <- Renterramat2005         %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterbeer2005          <- Renterbeer2005          %>%  dplyr::filter( grossIncome > medianInc2005)
 richRentermodiin2005        <- Rentermodiin2005        %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterbetshemesh2005    <- Renterbetshemesh2005    %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenternahariyya2005     <- Renternahariyya2005     %>%  dplyr::filter( grossIncome > medianInc2005)
 richRenterqiryatatta2005    <- Renterqiryatatta2005    %>%  dplyr::filter( grossIncome > medianInc2005)
 richRentergivatayim2005     <- Rentergivatayim2005     %>%  dplyr::filter( grossIncome > medianInc2005)

 richRenterjerusalem2006     <- Renterjerusalem2006     %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterAshdod2006        <- RenterAshdod2006        %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterHaifa2006         <- RenterHaifa2006         %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterHerzliyya2006     <- RenterHerzliyya2006     %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterHolon2006         <- RenterHolon2006         %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterLod2006           <- RenterLod2006           %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterHadera2006        <- RenterHadera2006        %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterAshqelon2006      <- RenterAshqelon2006      %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterNettanya2006      <- RenterNettanya2006      %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterRehovot2006       <- RenterRehovot2006       %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterRamla2006         <- RenterRamla2006         %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterRaannana2006      <- RenterRaannana2006      %>%  dplyr::filter( grossIncome > medianInc2006)
 richRentertlv2006           <- Rentertlv2006           %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterbene2006          <- Renterbene2006          %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterbat2006           <- Renterbat2006           %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterkefar2006         <- Renterkefar2006         %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterpetah2006         <- Renterpetah2006         %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterrishon2006        <- Renterrishon2006        %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterramat2006         <- Renterramat2006         %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterbeer2006          <- Renterbeer2006          %>%  dplyr::filter( grossIncome > medianInc2006)
 richRentermodiin2006        <- Rentermodiin2006        %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterbetshemesh2006    <- Renterbetshemesh2006    %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenternahariyya2006     <- Renternahariyya2006     %>%  dplyr::filter( grossIncome > medianInc2006)
 richRenterqiryatatta2006    <- Renterqiryatatta2006    %>%  dplyr::filter( grossIncome > medianInc2006)
 richRentergivatayim2006     <- Rentergivatayim2006     %>%  dplyr::filter( grossIncome > medianInc2006)

 richRenterjerusalem2007     <- Renterjerusalem2007     %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterAshdod2007        <- RenterAshdod2007        %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterHaifa2007         <- RenterHaifa2007         %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterHerzliyya2007     <- RenterHerzliyya2007     %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterHolon2007         <- RenterHolon2007         %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterLod2007           <- RenterLod2007           %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterHadera2007        <- RenterHadera2007        %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterAshqelon2007      <- RenterAshqelon2007      %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterNettanya2007      <- RenterNettanya2007      %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterRehovot2007       <- RenterRehovot2007       %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterRamla2007         <- RenterRamla2007         %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterRaannana2007      <- RenterRaannana2007      %>%  dplyr::filter( grossIncome > medianInc2007)
 richRentertlv2007           <- Rentertlv2007           %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterbene2007          <- Renterbene2007          %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterbat2007           <- Renterbat2007           %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterkefar2007         <- Renterkefar2007         %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterpetah2007         <- Renterpetah2007         %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterrishon2007        <- Renterrishon2007        %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterramat2007         <- Renterramat2007         %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterbeer2007          <- Renterbeer2007          %>%  dplyr::filter( grossIncome > medianInc2007)
 richRentermodiin2007        <- Rentermodiin2007        %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterbetshemesh2007    <- Renterbetshemesh2007    %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenternahariyya2007     <- Renternahariyya2007     %>%  dplyr::filter( grossIncome > medianInc2007)
 richRenterqiryatatta2007    <- Renterqiryatatta2007    %>%  dplyr::filter( grossIncome > medianInc2007)
 richRentergivatayim2007     <- Rentergivatayim2007     %>%  dplyr::filter( grossIncome > medianInc2007)

 richRenterjerusalem2008     <- Renterjerusalem2008     %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterAshdod2008        <- RenterAshdod2008        %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterHaifa2008         <- RenterHaifa2008         %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterHerzliyya2008     <- RenterHerzliyya2008     %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterHolon2008         <- RenterHolon2008         %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterLod2008           <- RenterLod2008           %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterHadera2008        <- RenterHadera2008        %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterAshqelon2008      <- RenterAshqelon2008      %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterNettanya2008      <- RenterNettanya2008      %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterRehovot2008       <- RenterRehovot2008       %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterRamla2008         <- RenterRamla2008         %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterRaannana2008      <- RenterRaannana2008      %>%  dplyr::filter( grossIncome > medianInc2008)
 richRentertlv2008           <- Rentertlv2008           %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterbene2008          <- Renterbene2008          %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterbat2008           <- Renterbat2008           %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterkefar2008         <- Renterkefar2008         %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterpetah2008         <- Renterpetah2008         %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterrishon2008        <- Renterrishon2008        %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterramat2008         <- Renterramat2008         %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterbeer2008          <- Renterbeer2008          %>%  dplyr::filter( grossIncome > medianInc2008)
 richRentermodiin2008        <- Rentermodiin2008        %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterbetshemesh2008    <- Renterbetshemesh2008    %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenternahariyya2008     <- Renternahariyya2008     %>%  dplyr::filter( grossIncome > medianInc2008)
 richRenterqiryatatta2008    <- Renterqiryatatta2008    %>%  dplyr::filter( grossIncome > medianInc2008)
 richRentergivatayim2008     <- Rentergivatayim2008     %>%  dplyr::filter( grossIncome > medianInc2008)

 richRenterjerusalem2009     <- Renterjerusalem2009     %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterAshdod2009        <- RenterAshdod2009        %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterHaifa2009         <- RenterHaifa2009         %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterHerzliyya2009     <- RenterHerzliyya2009     %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterHolon2009         <- RenterHolon2009         %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterLod2009           <- RenterLod2009           %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterHadera2009        <- RenterHadera2009        %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterAshqelon2009      <- RenterAshqelon2009      %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterNettanya2009      <- RenterNettanya2009      %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterRehovot2009       <- RenterRehovot2009       %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterRamla2009         <- RenterRamla2009         %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterRaannana2009      <- RenterRaannana2009      %>%  dplyr::filter( grossIncome > medianInc2009)
 richRentertlv2009           <- Rentertlv2009           %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterbene2009          <- Renterbene2009          %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterbat2009           <- Renterbat2009           %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterkefar2009         <- Renterkefar2009         %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterpetah2009         <- Renterpetah2009         %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterrishon2009        <- Renterrishon2009        %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterramat2009         <- Renterramat2009         %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterbeer2009          <- Renterbeer2009          %>%  dplyr::filter( grossIncome > medianInc2009)
 richRentermodiin2009        <- Rentermodiin2009        %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterbetshemesh2009    <- Renterbetshemesh2009    %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenternahariyya2009     <- Renternahariyya2009     %>%  dplyr::filter( grossIncome > medianInc2009)
 richRenterqiryatatta2009    <- Renterqiryatatta2009    %>%  dplyr::filter( grossIncome > medianInc2009)
 richRentergivatayim2009     <- Rentergivatayim2009     %>%  dplyr::filter( grossIncome > medianInc2009)

 richRenterjerusalem2010     <- Renterjerusalem2010     %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterAshdod2010        <- RenterAshdod2010        %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterHaifa2010         <- RenterHaifa2010         %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterHerzliyya2010     <- RenterHerzliyya2010     %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterHolon2010         <- RenterHolon2010         %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterLod2010           <- RenterLod2010           %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterHadera2010        <- RenterHadera2010        %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterAshqelon2010      <- RenterAshqelon2010      %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterNettanya2010      <- RenterNettanya2010      %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterRehovot2010       <- RenterRehovot2010       %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterRamla2010         <- RenterRamla2010         %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterRaannana2010      <- RenterRaannana2010      %>%  dplyr::filter( grossIncome > medianInc2010)
 richRentertlv2010           <- Rentertlv2010           %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterbene2010          <- Renterbene2010          %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterbat2010           <- Renterbat2010           %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterkefar2010         <- Renterkefar2010         %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterpetah2010         <- Renterpetah2010         %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterrishon2010        <- Renterrishon2010        %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterramat2010         <- Renterramat2010         %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterbeer2010          <- Renterbeer2010          %>%  dplyr::filter( grossIncome > medianInc2010)
 richRentermodiin2010        <- Rentermodiin2010        %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterbetshemesh2010    <- Renterbetshemesh2010    %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenternahariyya2010     <- Renternahariyya2010     %>%  dplyr::filter( grossIncome > medianInc2010)
 richRenterqiryatatta2010    <- Renterqiryatatta2010    %>%  dplyr::filter( grossIncome > medianInc2010)
 richRentergivatayim2010     <- Rentergivatayim2010     %>%  dplyr::filter( grossIncome > medianInc2010)

 richRenterjerusalem2011     <- Renterjerusalem2011     %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterAshdod2011        <- RenterAshdod2011        %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterHaifa2011         <- RenterHaifa2011         %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterHerzliyya2011     <- RenterHerzliyya2011     %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterHolon2011         <- RenterHolon2011         %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterLod2011           <- RenterLod2011           %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterHadera2011        <- RenterHadera2011        %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterAshqelon2011      <- RenterAshqelon2011      %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterNettanya2011      <- RenterNettanya2011      %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterRehovot2011       <- RenterRehovot2011       %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterRamla2011         <- RenterRamla2011         %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterRaannana2011      <- RenterRaannana2011      %>%  dplyr::filter( grossIncome > medianInc2011)
 richRentertlv2011           <- Rentertlv2011           %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterbene2011          <- Renterbene2011          %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterbat2011           <- Renterbat2011           %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterkefar2011         <- Renterkefar2011         %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterpetah2011         <- Renterpetah2011         %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterrishon2011        <- Renterrishon2011        %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterramat2011         <- Renterramat2011         %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterbeer2011          <- Renterbeer2011          %>%  dplyr::filter( grossIncome > medianInc2011)
 richRentermodiin2011        <- Rentermodiin2011        %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterbetshemesh2011    <- Renterbetshemesh2011    %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenternahariyya2011     <- Renternahariyya2011     %>%  dplyr::filter( grossIncome > medianInc2011)
 richRenterqiryatatta2011    <- Renterqiryatatta2011    %>%  dplyr::filter( grossIncome > medianInc2011)
 richRentergivatayim2011     <- Rentergivatayim2011     %>%  dplyr::filter( grossIncome > medianInc2011)

 richRenterjerusalem2012     <- Renterjerusalem2012     %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterAshdod2012        <- RenterAshdod2012        %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterHaifa2012         <- RenterHaifa2012         %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterHerzliyya2012     <- RenterHerzliyya2012     %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterHolon2012         <- RenterHolon2012         %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterLod2012           <- RenterLod2012           %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterHadera2012        <- RenterHadera2012        %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterAshqelon2012      <- RenterAshqelon2012      %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterNettanya2012      <- RenterNettanya2012      %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterRehovot2012       <- RenterRehovot2012       %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterRamla2012         <- RenterRamla2012         %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterRaannana2012      <- RenterRaannana2012      %>%  dplyr::filter( grossIncome > medianInc2012)
 richRentertlv2012           <- Rentertlv2012           %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterbene2012          <- Renterbene2012          %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterbat2012           <- Renterbat2012           %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterkefar2012         <- Renterkefar2012         %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterpetah2012         <- Renterpetah2012         %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterrishon2012        <- Renterrishon2012        %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterramat2012         <- Renterramat2012         %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterbeer2012          <- Renterbeer2012          %>%  dplyr::filter( grossIncome > medianInc2012)
 richRentermodiin2012        <- Rentermodiin2012        %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterbetshemesh2012    <- Renterbetshemesh2012    %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenternahariyya2012     <- Renternahariyya2012     %>%  dplyr::filter( grossIncome > medianInc2012)
 richRenterqiryatatta2012    <- Renterqiryatatta2012    %>%  dplyr::filter( grossIncome > medianInc2012)
 richRentergivatayim2012     <- Rentergivatayim2012     %>%  dplyr::filter( grossIncome > medianInc2012)

 richRenterjerusalem2013     <- Renterjerusalem2013     %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterAshdod2013        <- RenterAshdod2013        %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterHaifa2013         <- RenterHaifa2013         %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterHerzliyya2013     <- RenterHerzliyya2013     %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterHolon2013         <- RenterHolon2013         %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterLod2013           <- RenterLod2013           %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterHadera2013        <- RenterHadera2013        %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterAshqelon2013      <- RenterAshqelon2013      %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterNettanya2013      <- RenterNettanya2013      %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterRehovot2013       <- RenterRehovot2013       %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterRamla2013         <- RenterRamla2013         %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterRaannana2013      <- RenterRaannana2013      %>%  dplyr::filter( grossIncome > medianInc2013)
 richRentertlv2013           <- Rentertlv2013           %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterbene2013          <- Renterbene2013          %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterbat2013           <- Renterbat2013           %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterkefar2013         <- Renterkefar2013         %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterpetah2013         <- Renterpetah2013         %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterrishon2013        <- Renterrishon2013        %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterramat2013         <- Renterramat2013         %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterbeer2013          <- Renterbeer2013          %>%  dplyr::filter( grossIncome > medianInc2013)
 richRentermodiin2013        <- Rentermodiin2013        %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterbetshemesh2013    <- Renterbetshemesh2013    %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenternahariyya2013     <- Renternahariyya2013     %>%  dplyr::filter( grossIncome > medianInc2013)
 richRenterqiryatatta2013    <- Renterqiryatatta2013    %>%  dplyr::filter( grossIncome > medianInc2013)
 richRentergivatayim2013     <- Rentergivatayim2013     %>%  dplyr::filter( grossIncome > medianInc2013)

 richRenterjerusalem2014     <- Renterjerusalem2014     %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterAshdod2014        <- RenterAshdod2014        %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterHaifa2014         <- RenterHaifa2014         %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterHerzliyya2014     <- RenterHerzliyya2014     %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterHolon2014         <- RenterHolon2014         %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterLod2014           <- RenterLod2014           %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterHadera2014        <- RenterHadera2014        %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterAshqelon2014      <- RenterAshqelon2014      %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterNettanya2014      <- RenterNettanya2014      %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterRehovot2014       <- RenterRehovot2014       %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterRamla2014         <- RenterRamla2014         %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterRaannana2014      <- RenterRaannana2014      %>%  dplyr::filter( grossIncome > medianInc2014)
 richRentertlv2014           <- Rentertlv2014           %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterbene2014          <- Renterbene2014          %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterbat2014           <- Renterbat2014           %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterkefar2014         <- Renterkefar2014         %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterpetah2014         <- Renterpetah2014         %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterrishon2014        <- Renterrishon2014        %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterramat2014         <- Renterramat2014         %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterbeer2014          <- Renterbeer2014          %>%  dplyr::filter( grossIncome > medianInc2014)
 richRentermodiin2014        <- Rentermodiin2014        %>%  dplyr::filter( grossIncome > medianInc2014)
 richRenterbetshemesh2014    <- Renterbetshemesh2014    %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenternahariyya2014     <- Renternahariyya2014     %>%  dplyr::filter( grossIncome > medianInc2004)
 richRenterqiryatatta2014    <- Renterqiryatatta2014    %>%  dplyr::filter( grossIncome > medianInc2004)
 richRentergivatayim2014     <- Rentergivatayim2014     %>%  dplyr::filter( grossIncome > medianInc2004)

############   renter ##### below median income  ###############

 poorRenterjerusalem2004     <- Renterjerusalem2004     %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterAshdod2004        <- RenterAshdod2004        %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterHaifa2004         <- RenterHaifa2004         %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterHerzliyya2004     <- RenterHerzliyya2004     %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterHolon2004         <- RenterHolon2004         %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterLod2004           <- RenterLod2004           %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterHadera2004        <- RenterHadera2004        %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterAshqelon2004      <- RenterAshqelon2004      %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterNettanya2004      <- RenterNettanya2004      %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterRehovot2004       <- RenterRehovot2004       %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterRamla2004         <- RenterRamla2004         %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterRaannana2004      <- RenterRaannana2004      %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRentertlv2004           <- Rentertlv2004           %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterbene2004          <- Renterbene2004          %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterbat2004           <- Renterbat2004           %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterkefar2004         <- Renterkefar2004         %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterpetah2004         <- Renterpetah2004         %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterrishon2004        <- Renterrishon2004        %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterramat2004         <- Renterramat2004         %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterbeer2004          <- Renterbeer2004          %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRentermodiin2004        <- Rentermodiin2004        %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterbetshemesh2004    <- Renterbetshemesh2004    %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenternahariyya2004     <- Renternahariyya2004     %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterqiryatatta2004    <- Renterqiryatatta2004    %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRentergivatayim2004     <- Rentergivatayim2004     %>%  dplyr::filter( grossIncome <= medianInc2004)

 poorRenterjerusalem2005     <- Renterjerusalem2005     %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterAshdod2005        <- RenterAshdod2005        %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterHaifa2005         <- RenterHaifa2005         %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterHerzliyya2005     <- RenterHerzliyya2005     %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterHolon2005         <- RenterHolon2005         %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterLod2005           <- RenterLod2005           %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterHadera2005        <- RenterHadera2005        %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterAshqelon2005      <- RenterAshqelon2005      %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterNettanya2005      <- RenterNettanya2005      %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterRehovot2005       <- RenterRehovot2005       %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterRamla2005         <- RenterRamla2005         %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterRaannana2005      <- RenterRaannana2005      %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRentertlv2005           <- Rentertlv2005           %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterbene2005          <- Renterbene2005          %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterbat2005           <- Renterbat2005           %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterkefar2005         <- Renterkefar2005         %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterpetah2005         <- Renterpetah2005         %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterrishon2005        <- Renterrishon2005        %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterramat2005         <- Renterramat2005         %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterbeer2005          <- Renterbeer2005          %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRentermodiin2005        <- Rentermodiin2005        %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterbetshemesh2005    <- Renterbetshemesh2005    %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenternahariyya2005     <- Renternahariyya2005     %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRenterqiryatatta2005    <- Renterqiryatatta2005    %>%  dplyr::filter( grossIncome <= medianInc2005)
 poorRentergivatayim2005     <- Rentergivatayim2005     %>%  dplyr::filter( grossIncome <= medianInc2005)

 poorRenterjerusalem2006     <- Renterjerusalem2006     %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterAshdod2006        <- RenterAshdod2006        %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterHaifa2006         <- RenterHaifa2006         %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterHerzliyya2006     <- RenterHerzliyya2006     %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterHolon2006         <- RenterHolon2006         %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterLod2006           <- RenterLod2006           %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterHadera2006        <- RenterHadera2006        %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterAshqelon2006      <- RenterAshqelon2006      %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterNettanya2006      <- RenterNettanya2006      %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterRehovot2006       <- RenterRehovot2006       %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterRamla2006         <- RenterRamla2006         %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterRaannana2006      <- RenterRaannana2006      %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRentertlv2006           <- Rentertlv2006           %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterbene2006          <- Renterbene2006          %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterbat2006           <- Renterbat2006           %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterkefar2006         <- Renterkefar2006         %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterpetah2006         <- Renterpetah2006         %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterrishon2006        <- Renterrishon2006        %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterramat2006         <- Renterramat2006         %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterbeer2006          <- Renterbeer2006          %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRentermodiin2006        <- Rentermodiin2006        %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterbetshemesh2006    <- Renterbetshemesh2006    %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenternahariyya2006     <- Renternahariyya2006     %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRenterqiryatatta2006    <- Renterqiryatatta2006    %>%  dplyr::filter( grossIncome <= medianInc2006)
 poorRentergivatayim2006     <- Rentergivatayim2006     %>%  dplyr::filter( grossIncome <= medianInc2006)

 poorRenterjerusalem2007     <- Renterjerusalem2007     %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterAshdod2007        <- RenterAshdod2007        %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterHaifa2007         <- RenterHaifa2007         %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterHerzliyya2007     <- RenterHerzliyya2007     %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterHolon2007         <- RenterHolon2007         %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterLod2007           <- RenterLod2007           %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterHadera2007        <- RenterHadera2007        %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterAshqelon2007      <- RenterAshqelon2007      %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterNettanya2007      <- RenterNettanya2007      %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterRehovot2007       <- RenterRehovot2007       %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterRamla2007         <- RenterRamla2007         %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterRaannana2007      <- RenterRaannana2007      %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRentertlv2007           <- Rentertlv2007           %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterbene2007          <- Renterbene2007          %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterbat2007           <- Renterbat2007           %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterkefar2007         <- Renterkefar2007         %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterpetah2007         <- Renterpetah2007         %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterrishon2007        <- Renterrishon2007        %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterramat2007         <- Renterramat2007         %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterbeer2007          <- Renterbeer2007          %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRentermodiin2007        <- Rentermodiin2007        %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterbetshemesh2007    <- Renterbetshemesh2007    %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenternahariyya2007     <- Renternahariyya2007     %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRenterqiryatatta2007    <- Renterqiryatatta2007    %>%  dplyr::filter( grossIncome <= medianInc2007)
 poorRentergivatayim2007     <- Rentergivatayim2007     %>%  dplyr::filter( grossIncome <= medianInc2007)

 poorRenterjerusalem2008     <- Renterjerusalem2008     %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterAshdod2008        <- RenterAshdod2008        %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterHaifa2008         <- RenterHaifa2008         %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterHerzliyya2008     <- RenterHerzliyya2008     %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterHolon2008         <- RenterHolon2008         %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterLod2008           <- RenterLod2008           %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterHadera2008        <- RenterHadera2008        %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterAshqelon2008      <- RenterAshqelon2008      %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterNettanya2008      <- RenterNettanya2008      %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterRehovot2008       <- RenterRehovot2008       %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterRamla2008         <- RenterRamla2008         %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterRaannana2008      <- RenterRaannana2008      %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRentertlv2008           <- Rentertlv2008           %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterbene2008          <- Renterbene2008          %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterbat2008           <- Renterbat2008           %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterkefar2008         <- Renterkefar2008         %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterpetah2008         <- Renterpetah2008         %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterrishon2008        <- Renterrishon2008        %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterramat2008         <- Renterramat2008         %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterbeer2008          <- Renterbeer2008          %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRentermodiin2008        <- Rentermodiin2008        %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterbetshemesh2008    <- Renterbetshemesh2008    %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenternahariyya2008     <- Renternahariyya2008     %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRenterqiryatatta2008    <- Renterqiryatatta2008    %>%  dplyr::filter( grossIncome <= medianInc2008)
 poorRentergivatayim2008     <- Rentergivatayim2008     %>%  dplyr::filter( grossIncome <= medianInc2008)

 poorRenterjerusalem2009     <- Renterjerusalem2009     %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterAshdod2009        <- RenterAshdod2009        %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterHaifa2009         <- RenterHaifa2009         %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterHerzliyya2009     <- RenterHerzliyya2009     %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterHolon2009         <- RenterHolon2009         %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterLod2009           <- RenterLod2009           %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterHadera2009        <- RenterHadera2009        %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterAshqelon2009      <- RenterAshqelon2009      %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterNettanya2009      <- RenterNettanya2009      %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterRehovot2009       <- RenterRehovot2009       %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterRamla2009         <- RenterRamla2009         %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterRaannana2009      <- RenterRaannana2009      %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRentertlv2009           <- Rentertlv2009           %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterbene2009          <- Renterbene2009          %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterbat2009           <- Renterbat2009           %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterkefar2009         <- Renterkefar2009         %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterpetah2009         <- Renterpetah2009         %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterrishon2009        <- Renterrishon2009        %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterramat2009         <- Renterramat2009         %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterbeer2009          <- Renterbeer2009          %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRentermodiin2009        <- Rentermodiin2009        %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterbetshemesh2009    <- Renterbetshemesh2009    %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenternahariyya2009     <- Renternahariyya2009     %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRenterqiryatatta2009    <- Renterqiryatatta2009    %>%  dplyr::filter( grossIncome <= medianInc2009)
 poorRentergivatayim2009     <- Rentergivatayim2009     %>%  dplyr::filter( grossIncome <= medianInc2009)

 poorRenterjerusalem2010     <- Renterjerusalem2010     %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterAshdod2010        <- RenterAshdod2010        %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterHaifa2010         <- RenterHaifa2010         %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterHerzliyya2010     <- RenterHerzliyya2010     %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterHolon2010         <- RenterHolon2010         %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterLod2010           <- RenterLod2010           %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterHadera2010        <- RenterHadera2010        %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterAshqelon2010      <- RenterAshqelon2010      %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterNettanya2010      <- RenterNettanya2010      %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterRehovot2010       <- RenterRehovot2010       %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterRamla2010         <- RenterRamla2010         %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterRaannana2010      <- RenterRaannana2010      %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRentertlv2010           <- Rentertlv2010           %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterbene2010          <- Renterbene2010          %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterbat2010           <- Renterbat2010           %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterkefar2010         <- Renterkefar2010         %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterpetah2010         <- Renterpetah2010         %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterrishon2010        <- Renterrishon2010        %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterramat2010         <- Renterramat2010         %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterbeer2010          <- Renterbeer2010          %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRentermodiin2010        <- Rentermodiin2010        %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterbetshemesh2010    <- Renterbetshemesh2010    %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenternahariyya2010     <- Renternahariyya2010     %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRenterqiryatatta2010    <- Renterqiryatatta2010    %>%  dplyr::filter( grossIncome <= medianInc2010)
 poorRentergivatayim2010     <- Rentergivatayim2010     %>%  dplyr::filter( grossIncome <= medianInc2010)

 poorRenterjerusalem2011     <- Renterjerusalem2011     %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterAshdod2011        <- RenterAshdod2011        %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterHaifa2011         <- RenterHaifa2011         %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterHerzliyya2011     <- RenterHerzliyya2011     %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterHolon2011         <- RenterHolon2011         %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterLod2011           <- RenterLod2011           %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterHadera2011        <- RenterHadera2011        %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterAshqelon2011      <- RenterAshqelon2011      %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterNettanya2011      <- RenterNettanya2011      %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterRehovot2011       <- RenterRehovot2011       %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterRamla2011         <- RenterRamla2011         %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterRaannana2011      <- RenterRaannana2011      %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRentertlv2011           <- Rentertlv2011           %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterbene2011          <- Renterbene2011          %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterbat2011           <- Renterbat2011           %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterkefar2011         <- Renterkefar2011         %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterpetah2011         <- Renterpetah2011         %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterrishon2011        <- Renterrishon2011        %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterramat2011         <- Renterramat2011         %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterbeer2011          <- Renterbeer2011          %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRentermodiin2011        <- Rentermodiin2011        %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterbetshemesh2011    <- Renterbetshemesh2011    %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenternahariyya2011     <- Renternahariyya2011     %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRenterqiryatatta2011    <- Renterqiryatatta2011    %>%  dplyr::filter( grossIncome <= medianInc2011)
 poorRentergivatayim2011     <- Rentergivatayim2011     %>%  dplyr::filter( grossIncome <= medianInc2011)

 poorRenterjerusalem2012     <- Renterjerusalem2012     %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterAshdod2012        <- RenterAshdod2012        %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterHaifa2012         <- RenterHaifa2012         %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterHerzliyya2012     <- RenterHerzliyya2012     %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterHolon2012         <- RenterHolon2012         %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterLod2012           <- RenterLod2012           %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterHadera2012        <- RenterHadera2012        %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterAshqelon2012      <- RenterAshqelon2012      %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterNettanya2012      <- RenterNettanya2012      %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterRehovot2012       <- RenterRehovot2012       %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterRamla2012         <- RenterRamla2012         %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterRaannana2012      <- RenterRaannana2012      %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRentertlv2012           <- Rentertlv2012           %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterbene2012          <- Renterbene2012          %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterbat2012           <- Renterbat2012           %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterkefar2012         <- Renterkefar2012         %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterpetah2012         <- Renterpetah2012         %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterrishon2012        <- Renterrishon2012        %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterramat2012         <- Renterramat2012         %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterbeer2012          <- Renterbeer2012          %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRentermodiin2012        <- Rentermodiin2012        %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterbetshemesh2012    <- Renterbetshemesh2012    %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenternahariyya2012     <- Renternahariyya2012     %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRenterqiryatatta2012    <- Renterqiryatatta2012    %>%  dplyr::filter( grossIncome <= medianInc2012)
 poorRentergivatayim2012     <- Rentergivatayim2012     %>%  dplyr::filter( grossIncome <= medianInc2012)

 poorRenterjerusalem2013     <- Renterjerusalem2013     %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterAshdod2013        <- RenterAshdod2013        %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterHaifa2013         <- RenterHaifa2013         %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterHerzliyya2013     <- RenterHerzliyya2013     %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterHolon2013         <- RenterHolon2013         %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterLod2013           <- RenterLod2013           %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterHadera2013        <- RenterHadera2013        %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterAshqelon2013      <- RenterAshqelon2013      %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterNettanya2013      <- RenterNettanya2013      %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterRehovot2013       <- RenterRehovot2013       %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterRamla2013         <- RenterRamla2013         %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterRaannana2013      <- RenterRaannana2013      %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRentertlv2013           <- Rentertlv2013           %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterbene2013          <- Renterbene2013          %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterbat2013           <- Renterbat2013           %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterkefar2013         <- Renterkefar2013         %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterpetah2013         <- Renterpetah2013         %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterrishon2013        <- Renterrishon2013        %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterramat2013         <- Renterramat2013         %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterbeer2013          <- Renterbeer2013          %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRentermodiin2013        <- Rentermodiin2013        %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterbetshemesh2013    <- Renterbetshemesh2013    %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenternahariyya2013     <- Renternahariyya2013     %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRenterqiryatatta2013    <- Renterqiryatatta2013    %>%  dplyr::filter( grossIncome <= medianInc2013)
 poorRentergivatayim2013     <- Rentergivatayim2013     %>%  dplyr::filter( grossIncome <= medianInc2013)

 poorRenterjerusalem2014     <- Renterjerusalem2014     %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterAshdod2014        <- RenterAshdod2014        %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterHaifa2014         <- RenterHaifa2014         %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterHerzliyya2014     <- RenterHerzliyya2014     %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterHolon2014         <- RenterHolon2014         %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterLod2014           <- RenterLod2014           %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterHadera2014        <- RenterHadera2014        %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterAshqelon2014      <- RenterAshqelon2014      %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterNettanya2014      <- RenterNettanya2014      %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterRehovot2014       <- RenterRehovot2014       %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterRamla2014         <- RenterRamla2014         %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterRaannana2014      <- RenterRaannana2014      %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRentertlv2014           <- Rentertlv2014           %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterbene2014          <- Renterbene2014          %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterbat2014           <- Renterbat2014           %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterkefar2014         <- Renterkefar2014         %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterpetah2014         <- Renterpetah2014         %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterrishon2014        <- Renterrishon2014        %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterramat2014         <- Renterramat2014         %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterbeer2014          <- Renterbeer2014          %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRentermodiin2014        <- Rentermodiin2014        %>%  dplyr::filter( grossIncome <= medianInc2014)
 poorRenterbetshemesh2014    <- Renterbetshemesh2014    %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenternahariyya2014     <- Renternahariyya2014     %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRenterqiryatatta2014    <- Renterqiryatatta2014    %>%  dplyr::filter( grossIncome <= medianInc2004)
 poorRentergivatayim2014     <- Rentergivatayim2014     %>%  dplyr::filter( grossIncome <= medianInc2004)
